...
const PODetails = ({ items, details, setDetails, totals }) => {
    ...
    const handleDelete = (index) => {
        let updated = details.filter((i, idx) => idx !== index);
        setDetails(updated);
    };
    return (
        <Box mt={1}>
...
const DetailAdd = forwardRef(
    ({ Varient, setVarient, current, setCurrent, items, setDetails }, ref) => {
